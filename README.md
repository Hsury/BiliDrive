...
<h1 align="center">- AcDrive -</h1>

<h4 align="center">☁️ AC云，支持任意文件的全速上传与下载 ☁️</h4>
...
```
python -m AcDrive login [-h] username password
...
```
python -m AcDrive upload [-h] [-b BLOCK_SIZE] [-t THREAD] file
...
上传完毕后，终端会打印一串META URL（通常以`adrive://`开头）用于下载或分享，请妥善保管

### 下载

```
python -m AcDrive download [-h] [-f] [-t THREAD] meta [file]

meta: META URL(通常以adrive://开头)
...
该模式下，程序会打印命令提示符`AcDrive > `，并等待用户输入命令
...
请合理使用本项目，避免对AcFun的存储与带宽资源造成无意义的浪费

该项目仅用于学习和技术交流，开发者不承担任何由使用者的行为带来的法律责任

## 许可证

AcDrive is under The Star And Thank Author License (SATA)
